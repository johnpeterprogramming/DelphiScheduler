...
type
  ...
  public
    ...
    tblScheduleAccounts, tblScheduleStudents, tblScheduleSubjects : TADOTable;
    dsScheduleAccounts, dsScheduleStudents, dsScheduleQuery, dsScheduleSubjects : TDataSource;
...
tblScheduleSubjects.Connection := conSchedule;
tblScheduleSubjects.TableName := 'Subjects';
...
dsScheduleSubjects.DataSet := tblScheduleSubjects;

tblScheduleAccounts.Open;
tblScheduleStudents.Open;
tblScheduleSubjects.Open;
end;
